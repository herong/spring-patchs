...
/**
 * Class to manage context metadata used for the configuration and execution of
 * the call.
 * 
...
public class CallMetaDataContext {
    ...
    private static final Map<Long, Object> cacheMeta = new ConcurrentHashMap<Long, Object>();
    ...
    /**
     * Create a ReturnResultSetParameter/SqlOutParameter depending on the
     * support provided by the JDBC driver used for the database in use.
     * 
     * @param parameterName
     *            the name of the parameter (also used as the name of the List
     *            returned in the output)
     * @param rowMapper
     *            a RowMapper implementation used to map the data returned in
     *            the result set
    ...
    /**
     * Get the name of the single out parameter for this call. If there are
     * multiple parameters, the name of the first one will be returned.
     */
     ...
     * 
     * @param dataSource
     *            the DataSource used to retrieve metadata
     */
    ...
    /**
     * Process the list of parameters provided, and if procedure column metadata
     * is used, the parameters will be matched against the metadata information
     * and any missing ones will be automatically included.
     * 
     * @param parameters
    ...
    /**
     * Reconcile the provided parameters with available metadata and add new
     * ones where appropriate.
     */
    protected List<SqlParameter> reconcileParameters(List<SqlParameter> parameters) {
        // added by herong on 20140401
        Long key = (long) (this.catalogName + "." + this.procedureName + "out").hashCode();
        Object o = cacheMeta.get(key);
        if (o != null) {
            return (List<SqlParameter>) o;
        }
            ...
            if (declaredParameters.containsKey(parNameToCheck) ||
                ...
                if (meta.getParameterType() == DatabaseMetaData.procedureColumnReturn) {
                    ...
                    if (meta.getParameterType() == DatabaseMetaData.procedureColumnOut) {
                        ...
                        if (meta.getParameterType() == DatabaseMetaData.procedureColumnInOut) {
        ...
        cacheMeta.put(key, workParameters); // added by herong on 20140401
        return workParameters;
    }

    /**
     * Match input parameter values with the parameters declared to be used in
     * the call.
     * 
     * @param parameterSource
     *            the input values
     * @return a Map containing the matched parameter names with the value taken
     *         from the input
     */
    public Map<String, Object> matchInParameterValuesWithCallParameters(SqlParameterSource parameterSource) {
        ...
        // lookup support
        // since the database metadata is not necessarily providing case
    ...
    public String createCallString() {
        ...
        // For Oracle where catalogs are not supported we need to reverse the
        // schema name

...
/**
 * Generic implementation for the {@link CallMetaDataProvider} interface. This
 * class can be extended to provide database specific behavior.
 * 
...
public class GenericCallMetaDataProvider implements CallMetaDataProvider {
    ...
    private static Map<Long, Object> cacheMeta = new ConcurrentHashMap<Long, Object>();
    ...
    /**
     * Specify whether the database supports the use of catalog name in
     * procedure calls
     */
    ...
    /**
     * Specify whether the database supports the use of schema name in procedure
     * calls
     */
    ...
    private void processProcedureColumns(DatabaseMetaData databaseMetaData, String catalogName, String schemaName, String procedureName) {
        ...
        try {
            // added by herong on 20140401
            Long key = (long) (metaDataCatalogName + metaDataSchemaName + metaDataProcedureName).hashCode();
            ...
            // added by herong on 20140401
            Long key2 = (long) (metaDataCatalogName + metaDataSchemaName + metaDataProcedureName + "pcol").hashCode();
            Object o2 = this.cacheMeta.get(key2);
            if (o2 != null) {
                callParameterMetaData = (List<CallParameterMetaData>) o2;
            } else {
                ...
                this.cacheMeta.put(key2, callParameterMetaData);
            }
